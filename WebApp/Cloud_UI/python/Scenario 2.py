...
def twin_barplots(df):
 ...
 health_keywords = 'health|hospital|doctor|disease|medicine|GP|medicare|clinic|medical|nurse|ward|hygiene|COVID|Cancer|AIDS|Heart attack|Ambulance|death|illness'
                 +'vitality|sick|sickness|diseases|doctors|healthy|hospitals|emergency|clinics|vaccine|vaccines|'
                 +'medicines|accident|fatal|obesity|mental|depression|anxiety|fever|headache|pain|first-aid|red cross|clinical'
...
def generate_heatmap(df):
 sports_keywords = "sports|sport|afl|footie|footy|soccer|cricket|tennis|hockey|AUSOPEN|AFL|Warner|BigBash|NRL|"
 ...
 heatmap, xedges, yedges = np.histogram2d(np.array(polarity), np.array(subjectivity), bins=(10,20))
